  ...
  modules["/social"] = {
    render: function renderSocialRoute() {
      return `
        ...
        <h1 class="tools-title"><i class="fa-solid fa-comments"></i>‎ ‎ Social</h1>
        <br>
        <div class="cards-container">
          <a href="/private-chat" class="nav-link tool-card" style="animation-delay: 0.35s;">
            <i class="fa-solid fa-message"></i>
            <h2>Private Chat</h2>
            <p class="card-desc">Direct messages and group chats.</p>
